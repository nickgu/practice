...
def inputTensor(line):
    '''
        to a matrix of len(line) with one-hot vector of letters.
    '''
...
def train(category_tensor, input_line_tensor, target_line_tensor, criterion, learning_rate, rnn):
    ...
    '''
        given category:
        iterate over line: predict next char.
        P(next_char | prefix, category)
    '''
...
def phase_train():
    ...
    for iter in range(1, n_iters + 1):
        output, loss = train(*randomTrainingExample(), criterion=criterion, learning_rate=learning_rate, rnn=rnn)
        total_loss += loss
